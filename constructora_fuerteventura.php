...
<div class="animsition">
    ...
    <div class="menu">
      ...
      <div class="menu-lang right-boxed">
        <a href="constructora_fuerteventura.php?lang=es">Esp</a>
        <a href="constructora_fuerteventura.php?lang=en">Eng</a>
      </div>
              ...
              <div class="news-carousel owl-carousel">
                <div class="news-item">
                  <div class="news-hover">
                    ...
                    <div class="content">
                      <h3 class="news-title"><?php echo $lang['CONSTRUCTION_SERVICE_IMG_1']; ?></h3>
                    </div>
                  </div>
                </div>
                <div class="news-item">
                  <div class="news-hover">
                    <div class="hover-border"><div></div></div>
                    <div class="content">
                      <h3 class="news-title"><?php echo $lang['CONSTRUCTION_SERVICE_IMG_2']; ?></h3>
                    </div>
                  </div>
                </div>
                <div class="news-item">
                  <div class="news-hover">
                    <div class="hover-border"><div></div></div>
                    <div class="content">
                      <h3 class="news-title"><?php echo $lang['CONSTRUCTION_SERVICE_IMG_3']; ?></h3>
                    </div>
                  </div>
                </div>
              </div>
...
-->
    ...
    <footer id="footer" class="footer section">
      <div class="footer-flex">
        ...
        <div class="flex-item">
          <ul>
            <li><a href="constructora_fuerteventura.php?lang=es">Esp</a></li>
            <li><a href="constructora_fuerteventura.php?lang=en">Eng</a></li>
          </ul>
        </div>
        <div class="flex-item">
          <div class="social-list">
