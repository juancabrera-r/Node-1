...
<div class="animsition">
    ...
    <section class="section-mod">
      <div class="container">
        <div class="row">
          <div class= ""> <h6 class="text-dark"><?php echo $lang['ALL_SERVICE_DESCRIPTION_TITLE']; ?></h6></div>
        </div>
      </div>
    </section>
    ...
    <footer id="footer" class="footer section">
      <div class="footer-flex">
        ...
        <div class="flex-item">
          <ul>
            <li><a href="particulares.php?lang=es">Esp</a></li>
            <li><a href="particulares.php?lang=en">Eng</a></li>
          </ul>
        </div>
        <div class="flex-item">
          <div class="social-list">
