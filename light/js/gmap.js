var mapLocation = new google.maps.LatLng(28.501276,-13.867047); //change coordinates here
var marker;
var map;
function initialize() {
    var mapOptions = {
    ...
    + '<div class="map-title">'
    + '<div class="brand" href="#"><div class="brand-info"><div class="brand-name">Node Gestión</div><div class="brand-text">Constructora & Estudio</div></div></div></div>'
    + '<p class="map-address">'
    + '<div class="map-address-row">'
    + '  <i class="fa fa-map-marker"></i>'
    + '  <span class="text"><strong>Isla la Graciosa, nº2, Puerto del Rosario.</strong><br>'
    + '  Collins Street</span>'
    + '</div>'
    + '<div class="map-address-row">'
    + '   <i class="fa fa-phone"></i>'
    + '   <span class="text">828 908 650</span>'
    + '</div>'
    + '<div class="map-address-row">'
    + '   <span class="map-email">'
    + '      <i class="fa fa-envelope"></i>'
    + '      <span class="text">info@nodegestion.es</span>'
    + '   </span>'
    + '</div>';
    ...
    marker = new google.maps.Marker({
        map: map,
        draggable: true,
        title: 'Node Gestion', //change title here
