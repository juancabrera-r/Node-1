...
<div class="animsition">
    ...
    <div class="menu">
      ...
      <div class="menu-lang right-boxed">
        <a href="inmobiliaria_fuerteventura.php?lang=es">Esp</a>
        <a href="inmobiliaria_fuerteventura.php?lang=en">Eng</a>
      </div>
    ...
    <section class="section-mod">
      <div class="container">
        <div class="row">
          <div class= ""> <h6 class="text-dark"><?php echo $lang['INMOBILIARIA_DESCRIPTION_TITLE']; ?></h6></div>
        </div>
      </div>
    </section>
